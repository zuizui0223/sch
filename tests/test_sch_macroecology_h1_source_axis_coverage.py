...
DESIGN = [
    ...
    ROOT / "data" / "SCH_MACROECOLOGY_DESIGN_RECODE_V28_TA1_BATCH_A.csv",
    ROOT / "data" / "SCH_MACROECOLOGY_DESIGN_RECODE_V29_TA1_BATCH_B.csv",
    ROOT / "data" / "SCH_MACROECOLOGY_DESIGN_RECODE_V30_TA1_BATCH_C.csv",
    ROOT / "data" / "SCH_MACROECOLOGY_DESIGN_RECODE_V31_TA1_BATCH_D.csv",
    ROOT / "data" / "SCH_MACROECOLOGY_DESIGN_RECODE_V32_TA1_BATCH_E.csv",
    ROOT / "data" / "SCH_MACROECOLOGY_DESIGN_RECODE_V34_TA2_BATCH_A.csv",
    ROOT / "data" / "SCH_MACROECOLOGY_DESIGN_RECODE_V36_TA2_BATCH_C.csv",
]
AXES = [
    ...
    ROOT / "data" / "SCH_MACROECOLOGY_TRAIT_AXIS_RECODE_V28_TA1_BATCH_A.csv",
]
...
def test_all_record_level_h1_candidates_are_source_axis_recoded():
    built = _build()
    assert built["n_record_level_h1_candidates"] == 39
    assert built["n_h1_candidates_with_source_axis_record"] == 39
...
def test_source_audit_separates_full_from_partial_downgrades():
    built = _build()
    assert built["n_h1_source_records_with_model_axis"] == 33

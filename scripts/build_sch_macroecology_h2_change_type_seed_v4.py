...
def build(path: Path) -> dict:
    ...
    result["status"] = "H2_CHANGE_TYPE_SEED_V4_PRIMULA_LOCAL_CONTEXTS_ADDED"
    marker = "primula_local_net_selection_contexts_do_not_replace_local_agent_component_geometry"
